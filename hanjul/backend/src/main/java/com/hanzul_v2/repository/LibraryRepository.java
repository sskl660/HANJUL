...
public interface LibraryRepository extends JpaRepository<LibraryEntity, Long> {
    ...
    List<LibraryEntity> findByLibraryFkUserIdAndMybookIsbn(UserEntity userEntity,int isbn);
    void deleteByLibraryFkUserIdAndMybookIsbn(UserEntity userEntity, int isbn);
}
